...
def lambda_handler(event, context):
    ...
    for reservation in response['Reservations']:
        for instance in reservation['Instances']:
            ...
            annotation = "Missing memory alarm"

            # Check for Memory Available Bytes alarm
            ...
            for alarm in alarms:
                ...
                if dimensions.get('InstanceId') == instance_id and alarm.get('MetricName') == 'Memory Available Bytes':
                    compliance_type = 'COMPLIANT'
                    annotation = "Memory alarm is present"
                    break
