...
def lambda_handler(event, context):
    ...
    try:
        ...
        for alarm in all_alarms:
            ...
            if has_alarm and actions_enabled:
                compliance_type = 'COMPLIANT'
                annotation = f"Metric '{metric_name}' has all required alarm actions configured and enabled."
            else:
                ...
                annotation = f"{missing_str} is disabled for Metric '{metric_name}'."
    ...
    for instance_id in instance_ids:
        ...
        found_metrics = metric_instance_map.get(instance_id, {})
